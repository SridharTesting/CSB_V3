...
@Component({
  selector: 'app-carassessmentt',
  templateUrl: './carassessmentt.component.html',
  styleUrls: ['./carassessmentt.component.css']
})
export class CARAssessmenttComponent {
